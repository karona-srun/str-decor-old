    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    <form id="quickForm" action="{{ url('/sales-order', $saleOrder->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="customer_id" class="form-control select2 select2-hidden-accessible"
                                            ...
                                            @foreach ($customers as $item)
                                                <option value="{{ $item->id }}" {{ $item->id == $saleOrder->customer_id ? 'selected' : '' }}>{{ $item->customer_name }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row bg-light p-2 mb-2">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sale_order" class="form-control" value="{{ $saleOrder->sale_order }}">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="sale_order_date"
                                            value="{{ $saleOrder->sale_order_date }}" class="form-control">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="expected_shipment_date"
                                            value="{{ $saleOrder->expected_shipment_date }}" class="form-control">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="warehouse" class="form-control" value="{{ $saleOrder->warehouse }}">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sale_person" class="form-control" value="{{ $saleOrder->sale_person }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="delivery_method"
                                            ...
                                            @foreach (__('app.delivery_method_items') as $item)
                                                <option value="{{ $item }}" {{  $item == $saleOrder->delivery_method ? 'selected' : '' }} >{{ $item }}</option>
                                            @endforeach
                                        </select>
