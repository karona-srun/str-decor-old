            ...
            <div class="card card-outline card-primary">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ url('/staff-exportexcel') }}" class="btn btn-outline-primary btn-sm"> <i class=" fas fa-download"></i>
                            {{ __('app.btn_download') }}</a>
                        @can('Staff List')
                        <a href="{{ url('staff-info/create') }}" class="btn btn-primary btn-sm"> <i class=" fas fa-plus"></i>
                            {{ __('app.btn_add') }}</a>
                        @endcan
                    </div>
                </div>
