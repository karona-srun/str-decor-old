                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-sm-6">
                                    ...
                                    <div class="col-12">
                                        <img src="{{ '/products/' . $product->photo }}" class="product-image" alt="Product Image">
                                    </div>
                                    <div class="col-12 product-image-thumbs">
                                        <div class="product-image-thumb"><img src="{{ '/products/' . $product->photo }}" alt="Product Image"></div>
                                        @foreach ($attachments as $item)
                                        <div class="product-image-thumb"><img src="{{ url('/attachments/', $item->name) }}" alt="Product Image"></div>
                                        @endforeach
                                    </div>
                                </div>
                                <div class="col-12 col-sm-6">
